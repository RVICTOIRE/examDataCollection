...
# Page pour télécharger des données non nettoyées

def page_telechargement_donnees():
    st.title("📥 Télécharger des données non nettoyées")
    
    try:
        # Chemin vers le fichier contenant les données brutes (à modifier selon votre cas)
        file_path = "C:/Users/DELL/Desktop/DIT/Data_colllection/examDataCollection/"  # Modifiez ici avec le chemin réel
        ...
        st.download_button(
            ...
            data=json_data,
            file_name="donnees_brutes.json",
            mime="application/json"
        )
        
        # Ajout du téléchargement en format Excel (XLSX) avec openpyxl
        excel_file_path = "donnees_brutes.xlsx"
...
def page_evaluation():
    ...
    with st.form("form_eval"):
        ...
        if submitted:
            ...
            st.success("🎉 Merci pour votre évaluation ! Vous allez être redirigé vers notre formulaire détaillé.")
